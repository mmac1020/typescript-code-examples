...
console.log(
  'string comparator should be true: ',
  stringComparator.compare(
    'this should return true because my firstString is so long',
    'yep'
  )
);
...
console.log(
  'number comparator should be true: ',
  numberComparator.compare(100000, 10)
);
...
console.log(
  'user comparator should be false: ',
  userComparator.compare(ben, celine)
);
